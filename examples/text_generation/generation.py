...
if __name__ == '__main__':
    ...
    model2maxlen = json.load(open("examples/text_generation/config/model2maxlen.json", "r"))
    ...
    dataset2prompt = json.load(open("examples/text_generation/config/dataset2prompt.json", "r"))
    dataset2maxlen = json.load(open("examples/text_generation/config/dataset2maxlen.json", "r"))
