...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        attn_weights = self.attn_scaling(self.qk_matmul(query_states, key_states.transpose(2, 3)), 1.0 / math.sqrt(self.head_dim))
        ...
        attn_output = self.av_matmul(attn_weights, value_states)
...
class LlamaDecoderLayer(nn.Module):
    ...
    def from_observed(cls, other):
        ...
        converted = cls(other.config, other.self_attn.layer_idx)
        for name, module in other.named_children():
            if isinstance(module, tuple(LLAMA_ATTENTION_CLASSES.values())):
